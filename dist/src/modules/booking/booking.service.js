...
const getBookingById = async (bookingId, userId, role) => {
    ...
    if (role === "CUSTOMER" && booking.customerId !== userId) {
        throw new AppError(httpStatus.FORBIDDEN, "You can only view your own bookings");
    }
...
const cancelBooking = async (bookingId, customerId) => {
    ...
    if (!cancellableStatuses.includes(booking.status)) {
        throw new AppError(httpStatus.BAD_REQUEST, "Cannot cancel booking at current status");
    }
